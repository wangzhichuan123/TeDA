...
if __name__ == "__main__":
    data_dir = "../data/OS-ABO-core"
    import pdb

    pdb.set_trace()
    train_dataset = ABOCoreDataset(data_dir, "train")
    seen_categories = train_dataset.label_list
    print(len(train_dataset))
    query_dataset = ABOCoreDataset(data_dir, "query")
    target_dataset = ABOCoreDataset(data_dir, "target")
    seen_categories = train_dataset.label_list
    ...
    train_dataset = ABOCoreDataset(data_dir, "train", modality="point")
    pc, label = train_dataset[0]
    train_dataset = ABOCoreDataset(data_dir, "train", modality="vox")
